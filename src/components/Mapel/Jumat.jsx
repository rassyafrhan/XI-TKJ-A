	...
	return (
		<>
			<div
				...
				<div className="w-[50%] text-base  font-medium">MPP</div>
			...
			<div
				...
				<div className="flex justify-center items-center text-sm">15.40-17.20</div>
			</div>
			<div
				className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">17.20-18.40</div>
			</div>
		</>
	)
}
