	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Desi Mega Utari, S.Kom" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Reyhan" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Rizky Farizi" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Salma" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Seli" Width="120px" />
						<div className="py-[3%]"></div>
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Absensi" Nama="Zahra" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan " Nama="Mahreza" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Salim" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kebersihan " Nama="Farhan Tyas" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Ranifah" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Keagamaan" Nama="Zidan" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kreatifitas I" Nama="Yolanda" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Kreatifitas II" Nama="Abyan" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kreatifitas III" Nama="Ihsan" Width="120px" />
					</div>
				</div>
