...
const Schedule = () => {
    ...
    piketGroup = [
        ["Bobby", "Jonathan", "Rihan", "Ridha", "Salim", "Zidan"],
        ["Arkan", "Ihsan", "Farhan Tyas", "Reyhan", "Salma", "Zahra"],
        ["Anisa", "Fariz", "Raisha", "Farhan M", "Seli A", "Yolanda"],
        ["Aldy", "Edi", "Nabiel", "Pratiwi", "Rizki Fatur", "Vannes"],
        ["Abyan", "Diva", "Ranifah", "Mahreza", "Octavian", "Rizki Farizi"],
        ["Meika", "Natasya", "Rima", "Dadan", "Septian"],
    ]
